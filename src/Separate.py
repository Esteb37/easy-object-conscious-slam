...
def save_image(image, count):
    ...
    if os.path.exists(os.path.join(image_directory, object_name)):
        image_path = os.path.join(image_directory, object_name, image_filename)
    else:
        os.makedirs(os.path.join(image_directory, object_name))
        image_path = os.path.join(image_directory, object_name, image_filename)
